...
%   rsz       -  resizing factor (can be [])
%
% Output
%   mPb_nmax  -  result, h x w
%
% History
%   create    -  Pablo Arbelaez (arbelaez@eecs.berkeley.edu), 12-01-2010
...
% smooth cues
gtheta = [1.5708, 1.1781, 0.7854, 0.3927, 0.0, 2.7489, 2.3562, 1.9635];
